...
#url = 'http://10.20.222.180:8080/service/iss-test?appkey=y2nmq2lo2bl6l2ku6kjq3up4ere7ebunbrsiznar&ver=2.0&scenario=&&city=&gps=32.904486,117.25678&time=2019-11-28+18:24:36&appsig=9574F4459A80D2AFD4C9F6C15CC7E2BF553A280C&appver=&history=&voiceid=&scenario=&method=iss.getTalk&dpi=&text='
url = 'http://route.igaicloud.cn:8088/service/iss?appkey=z2r3dwbfhi3kx7wrvvtqgujnkyxe4uawtiyi5cym&city=&ver=3.2&scenario=&udid=dadfs&appver=&isdialog=True&time=2019-01-09-12:39:17&debug=true&voiceid=&gps=&method=iss.getTalk&dpi=&history=&appsig=E5D986C1AFFA37601E02ADE153F6A8F70BE3C18E&text='
path = './poc.xlsx'
...
def auto_test(case_text, questionFocus):
    ...
    try:
        ...
        if jsonpath.jsonpath(r, '$..cancelDialog') and jsonpath.jsonpath(r, '$..questionFocus')[0].strip() == "TRUE":
            print(case_text.strip() + ' is Pass')
            conversation_list1.append(case_text)
            tmp_text = str(jsonpath.jsonpath(r, '$..cancelDialog')[0])
